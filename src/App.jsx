...
if(codigo == "manolo"){
  ...
  source = "./assets/marley/marleyn1.glb"
  source2 = "./assets/marley/marleyn1.usdz"
}else if(codigo == "botas"){
  source = "./assets/dracula/dracula1.glb"
  source2 = "./assets/dracula/dracula1.usdz"
  ...
  source = "./assets/barbie/barbienn2.glb"
  source2 = "./assets/barbie/barbienn2.usdz"
}else if(codigo == "kira"){
  ...
  source = "./assets/lulu/lul14.glb"
  source2 = "./assets/lulu/lul14.usdz"
